...
use Fo3nix\ShopifyGraphQL\ShopifyAdmin202507\CashTrackingSessionEdge;
use Fo3nix\ShopifyGraphQL\ShopifyAdmin202507\CashTrackingSession;
use Fo3nix\ShopifyGraphQL\ShopifyAdmin202507\PageInfo;

class CashTrackingSessionConnection
{
    protected $edges;
    protected $nodes;
    protected $pageInfo;
    ...
    public function getPageInfo()
    {
        ...
        public static function fromArray(array $data): self
        {
            ...
            if (isset($data['edges']) && $data['edges'] !== null) {
                $instance->edges = array_map(function($item) { return CashTrackingSessionEdge::fromArray($item); }, $data['edges']);
            }
            if (isset($data['nodes']) && $data['nodes'] !== null) {
                $instance->nodes = array_map(function($item) { return CashTrackingSession::fromArray($item); }, $data['nodes']);
            }
