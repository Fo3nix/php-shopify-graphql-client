...
use Fo3nix\ShopifyGraphQL\ShopifyAdmin202507\ExchangeV2Edge;
use Fo3nix\ShopifyGraphQL\ShopifyAdmin202507\ExchangeV2;
use Fo3nix\ShopifyGraphQL\ShopifyAdmin202507\PageInfo;

class ExchangeV2Connection
{
    protected $edges;
    protected $nodes;
    protected $pageInfo;
    ...
    public function getPageInfo()
    {
        ...
        public static function fromArray(array $data): self
        {
            ...
            if (isset($data['edges']) && $data['edges'] !== null) {
                $instance->edges = array_map(function($item) { return ExchangeV2Edge::fromArray($item); }, $data['edges']);
            }
            if (isset($data['nodes']) && $data['nodes'] !== null) {
                $instance->nodes = array_map(function($item) { return ExchangeV2::fromArray($item); }, $data['nodes']);
            }
