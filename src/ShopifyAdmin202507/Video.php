...
use Fo3nix\ShopifyGraphQL\ShopifyAdmin202507\VideoSource;
    ...
    public function getUpdatedAt()
    {
        ...
        public static function fromArray(array $data): self
        {
            ...
            if (isset($data['originalSource']) && $data['originalSource'] !== null) {
                $instance->originalSource = VideoSource::fromArray($data['originalSource']);
            }
            ...
            if (isset($data['sources']) && $data['sources'] !== null) {
                $instance->sources = array_map(function($item) { return VideoSource::fromArray($item); }, $data['sources']);
            }
