...
use Fo3nix\ShopifyGraphQL\ShopifyAdmin202507\MarketingActivityEdge;
use Fo3nix\ShopifyGraphQL\ShopifyAdmin202507\MarketingActivity;
use Fo3nix\ShopifyGraphQL\ShopifyAdmin202507\PageInfo;

class MarketingActivityConnection
{
    protected $edges;
    protected $nodes;
    protected $pageInfo;
    ...
    public function getPageInfo()
    {
        ...
        public static function fromArray(array $data): self
        {
            ...
            if (isset($data['edges']) && $data['edges'] !== null) {
                $instance->edges = array_map(function($item) { return MarketingActivityEdge::fromArray($item); }, $data['edges']);
            }
            if (isset($data['nodes']) && $data['nodes'] !== null) {
                $instance->nodes = array_map(function($item) { return MarketingActivity::fromArray($item); }, $data['nodes']);
            }
