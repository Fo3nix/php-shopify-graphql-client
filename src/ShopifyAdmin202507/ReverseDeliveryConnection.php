...
use Fo3nix\ShopifyGraphQL\ShopifyAdmin202507\ReverseDeliveryEdge;
use Fo3nix\ShopifyGraphQL\ShopifyAdmin202507\ReverseDelivery;
use Fo3nix\ShopifyGraphQL\ShopifyAdmin202507\PageInfo;

class ReverseDeliveryConnection
{
    protected $edges;
    protected $nodes;
    protected $pageInfo;
    ...
    public function getPageInfo()
    {
        ...
        public static function fromArray(array $data): self
        {
            ...
            if (isset($data['edges']) && $data['edges'] !== null) {
                $instance->edges = array_map(function($item) { return ReverseDeliveryEdge::fromArray($item); }, $data['edges']);
            }
            if (isset($data['nodes']) && $data['nodes'] !== null) {
                $instance->nodes = array_map(function($item) { return ReverseDelivery::fromArray($item); }, $data['nodes']);
            }
