...
use Fo3nix\ShopifyGraphQL\ShopifyAdmin202507\TaxonomyValueEdge;
use Fo3nix\ShopifyGraphQL\ShopifyAdmin202507\TaxonomyValue;
use Fo3nix\ShopifyGraphQL\ShopifyAdmin202507\PageInfo;

class TaxonomyValueConnection
{
    protected $edges;
    protected $nodes;
    protected $pageInfo;
    ...
    public function getPageInfo()
    {
        ...
        public static function fromArray(array $data): self
        {
            ...
            if (isset($data['edges']) && $data['edges'] !== null) {
                $instance->edges = array_map(function($item) { return TaxonomyValueEdge::fromArray($item); }, $data['edges']);
            }
            if (isset($data['nodes']) && $data['nodes'] !== null) {
                $instance->nodes = array_map(function($item) { return TaxonomyValue::fromArray($item); }, $data['nodes']);
            }
