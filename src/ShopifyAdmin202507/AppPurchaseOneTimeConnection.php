...
use Fo3nix\ShopifyGraphQL\ShopifyAdmin202507\AppPurchaseOneTimeEdge;
use Fo3nix\ShopifyGraphQL\ShopifyAdmin202507\AppPurchaseOneTime;
use Fo3nix\ShopifyGraphQL\ShopifyAdmin202507\PageInfo;

class AppPurchaseOneTimeConnection
{
    protected $edges;
    protected $nodes;
    protected $pageInfo;
    ...
    public function getPageInfo()
    {
        ...
        public static function fromArray(array $data): self
        {
            ...
            if (isset($data['edges']) && $data['edges'] !== null) {
                $instance->edges = array_map(function($item) { return AppPurchaseOneTimeEdge::fromArray($item); }, $data['edges']);
            }
            if (isset($data['nodes']) && $data['nodes'] !== null) {
                $instance->nodes = array_map(function($item) { return AppPurchaseOneTime::fromArray($item); }, $data['nodes']);
            }
