...
use Fo3nix\ShopifyGraphQL\ShopifyAdmin202507\StorefrontAccessTokenEdge;
use Fo3nix\ShopifyGraphQL\ShopifyAdmin202507\StorefrontAccessToken;
use Fo3nix\ShopifyGraphQL\ShopifyAdmin202507\PageInfo;

class StorefrontAccessTokenConnection
{
    protected $edges;
    protected $nodes;
    protected $pageInfo;
    ...
    public function getPageInfo()
    {
        ...
        public static function fromArray(array $data): self
        {
            ...
            if (isset($data['edges']) && $data['edges'] !== null) {
                $instance->edges = array_map(function($item) { return StorefrontAccessTokenEdge::fromArray($item); }, $data['edges']);
            }
            if (isset($data['nodes']) && $data['nodes'] !== null) {
                $instance->nodes = array_map(function($item) { return StorefrontAccessToken::fromArray($item); }, $data['nodes']);
            }
