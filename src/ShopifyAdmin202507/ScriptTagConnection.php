...
use Fo3nix\ShopifyGraphQL\ShopifyAdmin202507\ScriptTagEdge;
use Fo3nix\ShopifyGraphQL\ShopifyAdmin202507\ScriptTag;
use Fo3nix\ShopifyGraphQL\ShopifyAdmin202507\PageInfo;

class ScriptTagConnection
{
    protected $edges;
    protected $nodes;
    protected $pageInfo;
    ...
    public function getPageInfo()
    {
        ...
        public static function fromArray(array $data): self
        {
            ...
            if (isset($data['edges']) && $data['edges'] !== null) {
                $instance->edges = array_map(function($item) { return ScriptTagEdge::fromArray($item); }, $data['edges']);
            }
            if (isset($data['nodes']) && $data['nodes'] !== null) {
                $instance->nodes = array_map(function($item) { return ScriptTag::fromArray($item); }, $data['nodes']);
            }
