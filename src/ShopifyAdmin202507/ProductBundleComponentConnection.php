...
use Fo3nix\ShopifyGraphQL\ShopifyAdmin202507\ProductBundleComponentEdge;
use Fo3nix\ShopifyGraphQL\ShopifyAdmin202507\ProductBundleComponent;
use Fo3nix\ShopifyGraphQL\ShopifyAdmin202507\PageInfo;

class ProductBundleComponentConnection
{
    protected $edges;
    protected $nodes;
    protected $pageInfo;
    ...
    public function getPageInfo()
    {
        ...
        public static function fromArray(array $data): self
        {
            ...
            if (isset($data['edges']) && $data['edges'] !== null) {
                $instance->edges = array_map(function($item) { return ProductBundleComponentEdge::fromArray($item); }, $data['edges']);
            }
            if (isset($data['nodes']) && $data['nodes'] !== null) {
                $instance->nodes = array_map(function($item) { return ProductBundleComponent::fromArray($item); }, $data['nodes']);
            }
