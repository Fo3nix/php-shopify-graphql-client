...
use Fo3nix\ShopifyGraphQL\ShopifyAdmin202507\FulfillmentEventEdge;
use Fo3nix\ShopifyGraphQL\ShopifyAdmin202507\FulfillmentEvent;
use Fo3nix\ShopifyGraphQL\ShopifyAdmin202507\PageInfo;

class FulfillmentEventConnection
{
    protected $edges;
    protected $nodes;
    protected $pageInfo;
    ...
    public function getPageInfo()
    {
        ...
        public static function fromArray(array $data): self
        {
            ...
            if (isset($data['edges']) && $data['edges'] !== null) {
                $instance->edges = array_map(function($item) { return FulfillmentEventEdge::fromArray($item); }, $data['edges']);
            }
            if (isset($data['nodes']) && $data['nodes'] !== null) {
                $instance->nodes = array_map(function($item) { return FulfillmentEvent::fromArray($item); }, $data['nodes']);
            }
