...
use Fo3nix\ShopifyGraphQL\ShopifyAdmin202507\LocalizationExtensionEdge;
use Fo3nix\ShopifyGraphQL\ShopifyAdmin202507\LocalizationExtension;
use Fo3nix\ShopifyGraphQL\ShopifyAdmin202507\PageInfo;

class LocalizationExtensionConnection
{
    protected $edges;
    protected $nodes;
    protected $pageInfo;
    ...
    public function getPageInfo()
    {
        ...
        public static function fromArray(array $data): self
        {
            ...
            if (isset($data['edges']) && $data['edges'] !== null) {
                $instance->edges = array_map(function($item) { return LocalizationExtensionEdge::fromArray($item); }, $data['edges']);
            }
            if (isset($data['nodes']) && $data['nodes'] !== null) {
                $instance->nodes = array_map(function($item) { return LocalizationExtension::fromArray($item); }, $data['nodes']);
            }
