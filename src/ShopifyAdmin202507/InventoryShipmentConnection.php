...
use Fo3nix\ShopifyGraphQL\ShopifyAdmin202507\InventoryShipmentEdge;
use Fo3nix\ShopifyGraphQL\ShopifyAdmin202507\InventoryShipment;
use Fo3nix\ShopifyGraphQL\ShopifyAdmin202507\PageInfo;

class InventoryShipmentConnection
{
    protected $edges;
    protected $nodes;
    protected $pageInfo;
    ...
    public function getPageInfo()
    {
        ...
        public static function fromArray(array $data): self
        {
            ...
            if (isset($data['edges']) && $data['edges'] !== null) {
                $instance->edges = array_map(function($item) { return InventoryShipmentEdge::fromArray($item); }, $data['edges']);
            }
            if (isset($data['nodes']) && $data['nodes'] !== null) {
                $instance->nodes = array_map(function($item) { return InventoryShipment::fromArray($item); }, $data['nodes']);
            }
