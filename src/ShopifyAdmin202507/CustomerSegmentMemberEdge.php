...
use Fo3nix\ShopifyGraphQL\ShopifyAdmin202507\CustomerSegmentMember;

class CustomerSegmentMemberEdge
{
    protected $cursor;
    protected $node;
    ...
    public function getNode()
    {
        ...
        public static function fromArray(array $data): self
        {
            ...
            if (isset($data['node']) && $data['node'] !== null) {
                $instance->node = CustomerSegmentMember::fromArray($data['node']);
            }
            return $instance;
        }
