...
use Fo3nix\ShopifyGraphQL\ShopifyAdmin202507\TenderTransactionEdge;
use Fo3nix\ShopifyGraphQL\ShopifyAdmin202507\TenderTransaction;
use Fo3nix\ShopifyGraphQL\ShopifyAdmin202507\PageInfo;

class TenderTransactionConnection
{
    protected $edges;
    protected $nodes;
    protected $pageInfo;
    ...
    public function getPageInfo()
    {
        ...
        public static function fromArray(array $data): self
        {
            ...
            if (isset($data['edges']) && $data['edges'] !== null) {
                $instance->edges = array_map(function($item) { return TenderTransactionEdge::fromArray($item); }, $data['edges']);
            }
            if (isset($data['nodes']) && $data['nodes'] !== null) {
                $instance->nodes = array_map(function($item) { return TenderTransaction::fromArray($item); }, $data['nodes']);
            }
