...
use Fo3nix\ShopifyGraphQL\ShopifyAdmin202507\DeliveryProfileItemEdge;
use Fo3nix\ShopifyGraphQL\ShopifyAdmin202507\DeliveryProfileItem;
    ...
    public function getPageInfo()
    {
        ...
        public static function fromArray(array $data): self
        {
            ...
            if (isset($data['edges']) && $data['edges'] !== null) {
                $instance->edges = array_map(function($item) { return DeliveryProfileItemEdge::fromArray($item); }, $data['edges']);
            }
            if (isset($data['nodes']) && $data['nodes'] !== null) {
                $instance->nodes = array_map(function($item) { return DeliveryProfileItem::fromArray($item); }, $data['nodes']);
            }
