    ...
    public function getWeight()
    {
        ...
        public static function fromArray(array $data): self
        {
            ...
            if (isset($data['bundleComponents']) && $data['bundleComponents'] !== null) {
                $instance->bundleComponents = array_map(function($item) { return DraftOrderLineItem::fromArray($item); }, $data['bundleComponents']);
            }
            if (isset($data['components']) && $data['components'] !== null) {
                $instance->components = array_map(function($item) { return DraftOrderLineItem::fromArray($item); }, $data['components']);
            }
            ...
            if (isset($data['grams']) && $data['grams'] !== null) {
