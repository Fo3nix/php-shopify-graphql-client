...
use Fo3nix\ShopifyGraphQL\ShopifyAdmin202507\ReturnableFulfillmentLineItemEdge;
use Fo3nix\ShopifyGraphQL\ShopifyAdmin202507\ReturnableFulfillmentLineItem;
use Fo3nix\ShopifyGraphQL\ShopifyAdmin202507\PageInfo;

class ReturnableFulfillmentLineItemConnection
{
    protected $edges;
    protected $nodes;
    protected $pageInfo;
    ...
    public function getPageInfo()
    {
        ...
        public static function fromArray(array $data): self
        {
            ...
            if (isset($data['edges']) && $data['edges'] !== null) {
                $instance->edges = array_map(function($item) { return ReturnableFulfillmentLineItemEdge::fromArray($item); }, $data['edges']);
            }
            if (isset($data['nodes']) && $data['nodes'] !== null) {
                $instance->nodes = array_map(function($item) { return ReturnableFulfillmentLineItem::fromArray($item); }, $data['nodes']);
            }
