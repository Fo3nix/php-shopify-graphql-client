...
use Fo3nix\ShopifyGraphQL\ShopifyAdmin202507\ShopPayPaymentRequestReceiptEdge;
use Fo3nix\ShopifyGraphQL\ShopifyAdmin202507\ShopPayPaymentRequestReceipt;
    ...
    public function getPageInfo()
    {
        ...
        public static function fromArray(array $data): self
        {
            ...
            if (isset($data['edges']) && $data['edges'] !== null) {
                $instance->edges = array_map(function($item) { return ShopPayPaymentRequestReceiptEdge::fromArray($item); }, $data['edges']);
            }
            if (isset($data['nodes']) && $data['nodes'] !== null) {
                $instance->nodes = array_map(function($item) { return ShopPayPaymentRequestReceipt::fromArray($item); }, $data['nodes']);
            }
