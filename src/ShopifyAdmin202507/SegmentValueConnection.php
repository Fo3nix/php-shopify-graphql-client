...
use Fo3nix\ShopifyGraphQL\ShopifyAdmin202507\SegmentValueEdge;
use Fo3nix\ShopifyGraphQL\ShopifyAdmin202507\SegmentValue;
use Fo3nix\ShopifyGraphQL\ShopifyAdmin202507\PageInfo;

class SegmentValueConnection
{
    protected $edges;
    protected $nodes;
    protected $pageInfo;
    ...
    public function getPageInfo()
    {
        ...
        public static function fromArray(array $data): self
        {
            ...
            if (isset($data['edges']) && $data['edges'] !== null) {
                $instance->edges = array_map(function($item) { return SegmentValueEdge::fromArray($item); }, $data['edges']);
            }
            if (isset($data['nodes']) && $data['nodes'] !== null) {
                $instance->nodes = array_map(function($item) { return SegmentValue::fromArray($item); }, $data['nodes']);
            }
