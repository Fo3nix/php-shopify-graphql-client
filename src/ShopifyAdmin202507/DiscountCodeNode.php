...
use Fo3nix\ShopifyGraphQL\ShopifyAdmin202507\DiscountCode;
...
class DiscountCodeNode
{
    ...
    public function getMetafields()
    {
        ...
        {
            $instance = new self();
            if (isset($data['codeDiscount']) && $data['codeDiscount'] !== null) {
                $instance->codeDiscount = DiscountCode::fromArray($data['codeDiscount']);
            }
        ...
        {
            $data = [];
            if ($this->codeDiscount !== null) {
                $data['codeDiscount'] = $this->codeDiscount->asArray();
            }
            if ($this->events !== null) {
