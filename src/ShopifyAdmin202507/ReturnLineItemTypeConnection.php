...
use Fo3nix\ShopifyGraphQL\ShopifyAdmin202507\ReturnLineItemTypeEdge;
use Fo3nix\ShopifyGraphQL\ShopifyAdmin202507\PageInfo;

class ReturnLineItemTypeConnection
{
    protected $edges;
    protected $nodes;
    protected $pageInfo;
    ...
    public function getPageInfo()
    {
        ...
        public static function fromArray(array $data): self
        {
            ...
            if (isset($data['edges']) && $data['edges'] !== null) {
                $instance->edges = array_map(function($item) { return ReturnLineItemTypeEdge::fromArray($item); }, $data['edges']);
            }
