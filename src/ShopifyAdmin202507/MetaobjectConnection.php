...
use Fo3nix\ShopifyGraphQL\ShopifyAdmin202507\MetaobjectEdge;
use Fo3nix\ShopifyGraphQL\ShopifyAdmin202507\Metaobject;
use Fo3nix\ShopifyGraphQL\ShopifyAdmin202507\PageInfo;

class MetaobjectConnection
{
    protected $edges;
    protected $nodes;
    protected $pageInfo;
    ...
    public function getPageInfo()
    {
        ...
        public static function fromArray(array $data): self
        {
            ...
            if (isset($data['edges']) && $data['edges'] !== null) {
                $instance->edges = array_map(function($item) { return MetaobjectEdge::fromArray($item); }, $data['edges']);
            }
            if (isset($data['nodes']) && $data['nodes'] !== null) {
                $instance->nodes = array_map(function($item) { return Metaobject::fromArray($item); }, $data['nodes']);
            }
