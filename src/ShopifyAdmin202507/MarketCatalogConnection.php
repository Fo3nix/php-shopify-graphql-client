...
use Fo3nix\ShopifyGraphQL\ShopifyAdmin202507\MarketCatalogEdge;
use Fo3nix\ShopifyGraphQL\ShopifyAdmin202507\MarketCatalog;
use Fo3nix\ShopifyGraphQL\ShopifyAdmin202507\PageInfo;

class MarketCatalogConnection
{
    protected $edges;
    protected $nodes;
    protected $pageInfo;
    ...
    public function getPageInfo()
    {
        ...
        public static function fromArray(array $data): self
        {
            ...
            if (isset($data['edges']) && $data['edges'] !== null) {
                $instance->edges = array_map(function($item) { return MarketCatalogEdge::fromArray($item); }, $data['edges']);
            }
            if (isset($data['nodes']) && $data['nodes'] !== null) {
                $instance->nodes = array_map(function($item) { return MarketCatalog::fromArray($item); }, $data['nodes']);
            }
