...
use Fo3nix\ShopifyGraphQL\ShopifyAdmin202507\SubscriptionLineEdge;
use Fo3nix\ShopifyGraphQL\ShopifyAdmin202507\SubscriptionLine;
use Fo3nix\ShopifyGraphQL\ShopifyAdmin202507\PageInfo;

class SubscriptionLineConnection
{
    protected $edges;
    protected $nodes;
    protected $pageInfo;
    ...
    public function getPageInfo()
    {
        ...
        public static function fromArray(array $data): self
        {
            ...
            if (isset($data['edges']) && $data['edges'] !== null) {
                $instance->edges = array_map(function($item) { return SubscriptionLineEdge::fromArray($item); }, $data['edges']);
            }
            if (isset($data['nodes']) && $data['nodes'] !== null) {
                $instance->nodes = array_map(function($item) { return SubscriptionLine::fromArray($item); }, $data['nodes']);
            }
