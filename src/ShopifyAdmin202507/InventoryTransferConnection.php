...
use Fo3nix\ShopifyGraphQL\ShopifyAdmin202507\InventoryTransferEdge;
use Fo3nix\ShopifyGraphQL\ShopifyAdmin202507\InventoryTransfer;
use Fo3nix\ShopifyGraphQL\ShopifyAdmin202507\PageInfo;

class InventoryTransferConnection
{
    protected $edges;
    protected $nodes;
    protected $pageInfo;
    ...
    public function getPageInfo()
    {
        ...
        public static function fromArray(array $data): self
        {
            ...
            if (isset($data['edges']) && $data['edges'] !== null) {
                $instance->edges = array_map(function($item) { return InventoryTransferEdge::fromArray($item); }, $data['edges']);
            }
            if (isset($data['nodes']) && $data['nodes'] !== null) {
                $instance->nodes = array_map(function($item) { return InventoryTransfer::fromArray($item); }, $data['nodes']);
            }
