...
use Fo3nix\ShopifyGraphQL\ShopifyAdmin202507\ProductVariantComponentEdge;
use Fo3nix\ShopifyGraphQL\ShopifyAdmin202507\ProductVariantComponent;
use Fo3nix\ShopifyGraphQL\ShopifyAdmin202507\PageInfo;

class ProductVariantComponentConnection
{
    protected $edges;
    protected $nodes;
    protected $pageInfo;
    ...
    public function getPageInfo()
    {
        ...
        public static function fromArray(array $data): self
        {
            ...
            if (isset($data['edges']) && $data['edges'] !== null) {
                $instance->edges = array_map(function($item) { return ProductVariantComponentEdge::fromArray($item); }, $data['edges']);
            }
            if (isset($data['nodes']) && $data['nodes'] !== null) {
                $instance->nodes = array_map(function($item) { return ProductVariantComponent::fromArray($item); }, $data['nodes']);
            }
