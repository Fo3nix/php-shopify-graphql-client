...
use Fo3nix\ShopifyGraphQL\ShopifyAdmin202507\DeletionEventEdge;
use Fo3nix\ShopifyGraphQL\ShopifyAdmin202507\DeletionEvent;
use Fo3nix\ShopifyGraphQL\ShopifyAdmin202507\PageInfo;

class DeletionEventConnection
{
    protected $edges;
    protected $nodes;
    protected $pageInfo;
    ...
    public function getPageInfo()
    {
        ...
        public static function fromArray(array $data): self
        {
            ...
            if (isset($data['edges']) && $data['edges'] !== null) {
                $instance->edges = array_map(function($item) { return DeletionEventEdge::fromArray($item); }, $data['edges']);
            }
            if (isset($data['nodes']) && $data['nodes'] !== null) {
                $instance->nodes = array_map(function($item) { return DeletionEvent::fromArray($item); }, $data['nodes']);
            }
