...
use Fo3nix\ShopifyGraphQL\ShopifyAdmin202507\LocalizedFieldEdge;
use Fo3nix\ShopifyGraphQL\ShopifyAdmin202507\LocalizedField;
use Fo3nix\ShopifyGraphQL\ShopifyAdmin202507\PageInfo;

class LocalizedFieldConnection
{
    protected $edges;
    protected $nodes;
    protected $pageInfo;
    ...
    public function getPageInfo()
    {
        ...
        public static function fromArray(array $data): self
        {
            ...
            if (isset($data['edges']) && $data['edges'] !== null) {
                $instance->edges = array_map(function($item) { return LocalizedFieldEdge::fromArray($item); }, $data['edges']);
            }
            if (isset($data['nodes']) && $data['nodes'] !== null) {
                $instance->nodes = array_map(function($item) { return LocalizedField::fromArray($item); }, $data['nodes']);
            }
