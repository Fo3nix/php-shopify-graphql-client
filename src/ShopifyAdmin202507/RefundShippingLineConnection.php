...
use Fo3nix\ShopifyGraphQL\ShopifyAdmin202507\RefundShippingLineEdge;
use Fo3nix\ShopifyGraphQL\ShopifyAdmin202507\RefundShippingLine;
use Fo3nix\ShopifyGraphQL\ShopifyAdmin202507\PageInfo;

class RefundShippingLineConnection
{
    protected $edges;
    protected $nodes;
    protected $pageInfo;
    ...
    public function getPageInfo()
    {
        ...
        public static function fromArray(array $data): self
        {
            ...
            if (isset($data['edges']) && $data['edges'] !== null) {
                $instance->edges = array_map(function($item) { return RefundShippingLineEdge::fromArray($item); }, $data['edges']);
            }
            if (isset($data['nodes']) && $data['nodes'] !== null) {
                $instance->nodes = array_map(function($item) { return RefundShippingLine::fromArray($item); }, $data['nodes']);
            }
