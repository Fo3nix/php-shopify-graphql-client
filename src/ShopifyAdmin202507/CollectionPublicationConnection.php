...
use Fo3nix\ShopifyGraphQL\ShopifyAdmin202507\CollectionPublicationEdge;
use Fo3nix\ShopifyGraphQL\ShopifyAdmin202507\CollectionPublication;
use Fo3nix\ShopifyGraphQL\ShopifyAdmin202507\PageInfo;

class CollectionPublicationConnection
{
    protected $edges;
    protected $nodes;
    protected $pageInfo;
    ...
    public function getPageInfo()
    {
        ...
        public static function fromArray(array $data): self
        {
            ...
            if (isset($data['edges']) && $data['edges'] !== null) {
                $instance->edges = array_map(function($item) { return CollectionPublicationEdge::fromArray($item); }, $data['edges']);
            }
            if (isset($data['nodes']) && $data['nodes'] !== null) {
                $instance->nodes = array_map(function($item) { return CollectionPublication::fromArray($item); }, $data['nodes']);
            }
