...
use Fo3nix\ShopifyGraphQL\ShopifyAdmin202507\AppUsageRecordEdge;
use Fo3nix\ShopifyGraphQL\ShopifyAdmin202507\AppUsageRecord;
use Fo3nix\ShopifyGraphQL\ShopifyAdmin202507\PageInfo;

class AppUsageRecordConnection
{
    protected $edges;
    protected $nodes;
    protected $pageInfo;
    ...
    public function getPageInfo()
    {
        ...
        public static function fromArray(array $data): self
        {
            ...
            if (isset($data['edges']) && $data['edges'] !== null) {
                $instance->edges = array_map(function($item) { return AppUsageRecordEdge::fromArray($item); }, $data['edges']);
            }
            if (isset($data['nodes']) && $data['nodes'] !== null) {
                $instance->nodes = array_map(function($item) { return AppUsageRecord::fromArray($item); }, $data['nodes']);
            }
