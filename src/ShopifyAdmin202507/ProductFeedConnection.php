...
use Fo3nix\ShopifyGraphQL\ShopifyAdmin202507\ProductFeedEdge;
use Fo3nix\ShopifyGraphQL\ShopifyAdmin202507\ProductFeed;
use Fo3nix\ShopifyGraphQL\ShopifyAdmin202507\PageInfo;

class ProductFeedConnection
{
    protected $edges;
    protected $nodes;
    protected $pageInfo;
    ...
    public function getPageInfo()
    {
        ...
        public static function fromArray(array $data): self
        {
            ...
            if (isset($data['edges']) && $data['edges'] !== null) {
                $instance->edges = array_map(function($item) { return ProductFeedEdge::fromArray($item); }, $data['edges']);
            }
            if (isset($data['nodes']) && $data['nodes'] !== null) {
                $instance->nodes = array_map(function($item) { return ProductFeed::fromArray($item); }, $data['nodes']);
            }
