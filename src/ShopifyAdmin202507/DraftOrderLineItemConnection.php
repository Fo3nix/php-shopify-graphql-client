...
use Fo3nix\ShopifyGraphQL\ShopifyAdmin202507\DraftOrderLineItemEdge;
use Fo3nix\ShopifyGraphQL\ShopifyAdmin202507\DraftOrderLineItem;
use Fo3nix\ShopifyGraphQL\ShopifyAdmin202507\PageInfo;

class DraftOrderLineItemConnection
{
    protected $edges;
    protected $nodes;
    protected $pageInfo;
    ...
    public function getPageInfo()
    {
        ...
        public static function fromArray(array $data): self
        {
            ...
            if (isset($data['edges']) && $data['edges'] !== null) {
                $instance->edges = array_map(function($item) { return DraftOrderLineItemEdge::fromArray($item); }, $data['edges']);
            }
            if (isset($data['nodes']) && $data['nodes'] !== null) {
                $instance->nodes = array_map(function($item) { return DraftOrderLineItem::fromArray($item); }, $data['nodes']);
            }
