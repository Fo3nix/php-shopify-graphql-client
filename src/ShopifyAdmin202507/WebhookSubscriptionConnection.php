...
use Fo3nix\ShopifyGraphQL\ShopifyAdmin202507\WebhookSubscriptionEdge;
use Fo3nix\ShopifyGraphQL\ShopifyAdmin202507\WebhookSubscription;
use Fo3nix\ShopifyGraphQL\ShopifyAdmin202507\PageInfo;

class WebhookSubscriptionConnection
{
    protected $edges;
    protected $nodes;
    protected $pageInfo;
    ...
    public function getPageInfo()
    {
        ...
        public static function fromArray(array $data): self
        {
            ...
            if (isset($data['edges']) && $data['edges'] !== null) {
                $instance->edges = array_map(function($item) { return WebhookSubscriptionEdge::fromArray($item); }, $data['edges']);
            }
            if (isset($data['nodes']) && $data['nodes'] !== null) {
                $instance->nodes = array_map(function($item) { return WebhookSubscription::fromArray($item); }, $data['nodes']);
            }
