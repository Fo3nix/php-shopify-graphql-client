...
use Fo3nix\ShopifyGraphQL\ShopifyAdmin202507\DeliveryLocationGroupZoneEdge;
use Fo3nix\ShopifyGraphQL\ShopifyAdmin202507\DeliveryLocationGroupZone;
    ...
    public function getPageInfo()
    {
        ...
        public static function fromArray(array $data): self
        {
            ...
            if (isset($data['edges']) && $data['edges'] !== null) {
                $instance->edges = array_map(function($item) { return DeliveryLocationGroupZoneEdge::fromArray($item); }, $data['edges']);
            }
            if (isset($data['nodes']) && $data['nodes'] !== null) {
                $instance->nodes = array_map(function($item) { return DeliveryLocationGroupZone::fromArray($item); }, $data['nodes']);
            }
