...
use Fo3nix\ShopifyGraphQL\ShopifyAdmin202507\SellingPlanEdge;
use Fo3nix\ShopifyGraphQL\ShopifyAdmin202507\SellingPlan;
use Fo3nix\ShopifyGraphQL\ShopifyAdmin202507\PageInfo;

class SellingPlanConnection
{
    protected $edges;
    protected $nodes;
    protected $pageInfo;
    ...
    public function getPageInfo()
    {
        ...
        public static function fromArray(array $data): self
        {
            ...
            if (isset($data['edges']) && $data['edges'] !== null) {
                $instance->edges = array_map(function($item) { return SellingPlanEdge::fromArray($item); }, $data['edges']);
            }
            if (isset($data['nodes']) && $data['nodes'] !== null) {
                $instance->nodes = array_map(function($item) { return SellingPlan::fromArray($item); }, $data['nodes']);
            }
