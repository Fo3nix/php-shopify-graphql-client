...
class CheckoutBrandingControlColorRoles
{
    protected $accent;
    ...
    public function getText()
    {
        ...
        public static function fromArray(array $data): self
        {
            ...
            if (isset($data['selected']) && $data['selected'] !== null) {
                $instance->selected = CheckoutBrandingColorRoles::fromArray($data['selected']);
            }
        ...
        public function asArray(): array
        {
            ...
            if ($this->selected !== null) {
                $data['selected'] = $this->selected->asArray();
            }
            if ($this->text !== null) {
                $data['text'] = $this->text;
            }
