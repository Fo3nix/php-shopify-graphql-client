...
use Fo3nix\ShopifyGraphQL\ShopifyAdmin202507\DiscountRedeemCodeBulkCreationCodeEdge;
use Fo3nix\ShopifyGraphQL\ShopifyAdmin202507\DiscountRedeemCodeBulkCreationCode;
use Fo3nix\ShopifyGraphQL\ShopifyAdmin202507\PageInfo;

class DiscountRedeemCodeBulkCreationCodeConnection
{
    protected $edges;
    protected $nodes;
    protected $pageInfo;
    ...
    public function getPageInfo()
    {
        ...
        public static function fromArray(array $data): self
        {
            ...
            if (isset($data['edges']) && $data['edges'] !== null) {
                $instance->edges = array_map(function($item) { return DiscountRedeemCodeBulkCreationCodeEdge::fromArray($item); }, $data['edges']);
            }
            if (isset($data['nodes']) && $data['nodes'] !== null) {
                $instance->nodes = array_map(function($item) { return DiscountRedeemCodeBulkCreationCode::fromArray($item); }, $data['nodes']);
            }
