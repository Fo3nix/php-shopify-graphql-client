...
class SubscriptionPickupOptionQueryObject extends QueryObject
{
    ...
    public function selectLocation(SubscriptionPickupOptionLocationArgumentsObject $argsObject = null)
    {
    ...
    public function selectPrice(SubscriptionPickupOptionPriceArgumentsObject $argsObject = null)
    {
