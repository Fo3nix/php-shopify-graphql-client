...
use Fo3nix\ShopifyGraphQL\ShopifyAdmin202507\DiscountAutomaticNodeEdge;
use Fo3nix\ShopifyGraphQL\ShopifyAdmin202507\DiscountAutomaticNode;
use Fo3nix\ShopifyGraphQL\ShopifyAdmin202507\PageInfo;

class DiscountAutomaticNodeConnection
{
    protected $edges;
    protected $nodes;
    protected $pageInfo;
    ...
    public function getPageInfo()
    {
        ...
        public static function fromArray(array $data): self
        {
            ...
            if (isset($data['edges']) && $data['edges'] !== null) {
                $instance->edges = array_map(function($item) { return DiscountAutomaticNodeEdge::fromArray($item); }, $data['edges']);
            }
            if (isset($data['nodes']) && $data['nodes'] !== null) {
                $instance->nodes = array_map(function($item) { return DiscountAutomaticNode::fromArray($item); }, $data['nodes']);
            }
