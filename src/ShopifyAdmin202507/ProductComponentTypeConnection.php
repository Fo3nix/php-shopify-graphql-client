...
use Fo3nix\ShopifyGraphQL\ShopifyAdmin202507\ProductComponentTypeEdge;
use Fo3nix\ShopifyGraphQL\ShopifyAdmin202507\ProductComponentType;
use Fo3nix\ShopifyGraphQL\ShopifyAdmin202507\PageInfo;

class ProductComponentTypeConnection
{
    protected $edges;
    protected $nodes;
    protected $pageInfo;
    ...
    public function getPageInfo()
    {
        ...
        public static function fromArray(array $data): self
        {
            ...
            if (isset($data['edges']) && $data['edges'] !== null) {
                $instance->edges = array_map(function($item) { return ProductComponentTypeEdge::fromArray($item); }, $data['edges']);
            }
            if (isset($data['nodes']) && $data['nodes'] !== null) {
                $instance->nodes = array_map(function($item) { return ProductComponentType::fromArray($item); }, $data['nodes']);
            }
