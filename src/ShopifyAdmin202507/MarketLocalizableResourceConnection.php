...
use Fo3nix\ShopifyGraphQL\ShopifyAdmin202507\MarketLocalizableResourceEdge;
use Fo3nix\ShopifyGraphQL\ShopifyAdmin202507\MarketLocalizableResource;
use Fo3nix\ShopifyGraphQL\ShopifyAdmin202507\PageInfo;

class MarketLocalizableResourceConnection
{
    protected $edges;
    protected $nodes;
    protected $pageInfo;
    ...
    public function getPageInfo()
    {
        ...
        public static function fromArray(array $data): self
        {
            ...
            if (isset($data['edges']) && $data['edges'] !== null) {
                $instance->edges = array_map(function($item) { return MarketLocalizableResourceEdge::fromArray($item); }, $data['edges']);
            }
            if (isset($data['nodes']) && $data['nodes'] !== null) {
                $instance->nodes = array_map(function($item) { return MarketLocalizableResource::fromArray($item); }, $data['nodes']);
            }
