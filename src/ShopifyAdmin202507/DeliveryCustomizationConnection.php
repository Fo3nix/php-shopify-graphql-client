...
use Fo3nix\ShopifyGraphQL\ShopifyAdmin202507\DeliveryCustomizationEdge;
use Fo3nix\ShopifyGraphQL\ShopifyAdmin202507\DeliveryCustomization;
use Fo3nix\ShopifyGraphQL\ShopifyAdmin202507\PageInfo;

class DeliveryCustomizationConnection
{
    protected $edges;
    protected $nodes;
    protected $pageInfo;
    ...
    public function getPageInfo()
    {
        ...
        public static function fromArray(array $data): self
        {
            ...
            if (isset($data['edges']) && $data['edges'] !== null) {
                $instance->edges = array_map(function($item) { return DeliveryCustomizationEdge::fromArray($item); }, $data['edges']);
            }
            if (isset($data['nodes']) && $data['nodes'] !== null) {
                $instance->nodes = array_map(function($item) { return DeliveryCustomization::fromArray($item); }, $data['nodes']);
            }
