...
use Fo3nix\ShopifyGraphQL\ShopifyAdmin202507\CheckoutProfileEdge;
use Fo3nix\ShopifyGraphQL\ShopifyAdmin202507\CheckoutProfile;
use Fo3nix\ShopifyGraphQL\ShopifyAdmin202507\PageInfo;

class CheckoutProfileConnection
{
    protected $edges;
    protected $nodes;
    protected $pageInfo;
    ...
    public function getPageInfo()
    {
        ...
        public static function fromArray(array $data): self
        {
            ...
            if (isset($data['edges']) && $data['edges'] !== null) {
                $instance->edges = array_map(function($item) { return CheckoutProfileEdge::fromArray($item); }, $data['edges']);
            }
            if (isset($data['nodes']) && $data['nodes'] !== null) {
                $instance->nodes = array_map(function($item) { return CheckoutProfile::fromArray($item); }, $data['nodes']);
            }
