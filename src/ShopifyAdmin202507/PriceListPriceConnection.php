...
use Fo3nix\ShopifyGraphQL\ShopifyAdmin202507\PriceListPriceEdge;
use Fo3nix\ShopifyGraphQL\ShopifyAdmin202507\PriceListPrice;
use Fo3nix\ShopifyGraphQL\ShopifyAdmin202507\PageInfo;

class PriceListPriceConnection
{
    protected $edges;
    protected $nodes;
    protected $pageInfo;
    ...
    public function getPageInfo()
    {
        ...
        public static function fromArray(array $data): self
        {
            ...
            if (isset($data['edges']) && $data['edges'] !== null) {
                $instance->edges = array_map(function($item) { return PriceListPriceEdge::fromArray($item); }, $data['edges']);
            }
            if (isset($data['nodes']) && $data['nodes'] !== null) {
                $instance->nodes = array_map(function($item) { return PriceListPrice::fromArray($item); }, $data['nodes']);
            }
