...
use Fo3nix\ShopifyGraphQL\ShopifyAdmin202507\ExchangeLineItemEdge;
use Fo3nix\ShopifyGraphQL\ShopifyAdmin202507\ExchangeLineItem;
use Fo3nix\ShopifyGraphQL\ShopifyAdmin202507\PageInfo;

class ExchangeLineItemConnection
{
    protected $edges;
    protected $nodes;
    protected $pageInfo;
    ...
    public function getPageInfo()
    {
        ...
        public static function fromArray(array $data): self
        {
            ...
            if (isset($data['edges']) && $data['edges'] !== null) {
                $instance->edges = array_map(function($item) { return ExchangeLineItemEdge::fromArray($item); }, $data['edges']);
            }
            if (isset($data['nodes']) && $data['nodes'] !== null) {
                $instance->nodes = array_map(function($item) { return ExchangeLineItem::fromArray($item); }, $data['nodes']);
            }
