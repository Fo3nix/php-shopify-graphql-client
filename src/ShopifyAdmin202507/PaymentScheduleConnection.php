...
use Fo3nix\ShopifyGraphQL\ShopifyAdmin202507\PaymentScheduleEdge;
use Fo3nix\ShopifyGraphQL\ShopifyAdmin202507\PaymentSchedule;
    ...
    public function getPageInfo()
    {
        ...
        public static function fromArray(array $data): self
        {
            ...
            if (isset($data['edges']) && $data['edges'] !== null) {
                $instance->edges = array_map(function($item) { return PaymentScheduleEdge::fromArray($item); }, $data['edges']);
            }
            if (isset($data['nodes']) && $data['nodes'] !== null) {
                $instance->nodes = array_map(function($item) { return PaymentSchedule::fromArray($item); }, $data['nodes']);
            }
