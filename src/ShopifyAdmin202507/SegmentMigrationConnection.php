...
use Fo3nix\ShopifyGraphQL\ShopifyAdmin202507\SegmentMigrationEdge;
use Fo3nix\ShopifyGraphQL\ShopifyAdmin202507\SegmentMigration;
use Fo3nix\ShopifyGraphQL\ShopifyAdmin202507\PageInfo;

class SegmentMigrationConnection
{
    protected $edges;
    protected $nodes;
    protected $pageInfo;
    ...
    public function getPageInfo()
    {
        ...
        public static function fromArray(array $data): self
        {
            ...
            if (isset($data['edges']) && $data['edges'] !== null) {
                $instance->edges = array_map(function($item) { return SegmentMigrationEdge::fromArray($item); }, $data['edges']);
            }
            if (isset($data['nodes']) && $data['nodes'] !== null) {
                $instance->nodes = array_map(function($item) { return SegmentMigration::fromArray($item); }, $data['nodes']);
            }
