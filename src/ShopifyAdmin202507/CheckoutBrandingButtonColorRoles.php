...
class CheckoutBrandingButtonColorRoles
{
    protected $accent;
    ...
    public function getText()
    {
        ...
        public static function fromArray(array $data): self
        {
            ...
            if (isset($data['hover']) && $data['hover'] !== null) {
                $instance->hover = CheckoutBrandingColorRoles::fromArray($data['hover']);
            }
