...
use Fo3nix\ShopifyGraphQL\ShopifyAdmin202507\TaxonomyCategoryAttributeEdge;
use Fo3nix\ShopifyGraphQL\ShopifyAdmin202507\TaxonomyCategoryAttribute;
use Fo3nix\ShopifyGraphQL\ShopifyAdmin202507\PageInfo;

class TaxonomyCategoryAttributeConnection
{
    protected $edges;
    protected $nodes;
    protected $pageInfo;
    ...
    /**
     * @return TaxonomyCategoryAttribute[]
     */
    ...
    public function getPageInfo()
    {
        ...
        public static function fromArray(array $data): self
        {
            ...
            if (isset($data['edges']) && $data['edges'] !== null) {
                $instance->edges = array_map(function($item) { return TaxonomyCategoryAttributeEdge::fromArray($item); }, $data['edges']);
            }
            if (isset($data['nodes']) && $data['nodes'] !== null) {
                $instance->nodes = array_map(function($item) { return TaxonomyCategoryAttribute::fromArray($item); }, $data['nodes']);
            }
