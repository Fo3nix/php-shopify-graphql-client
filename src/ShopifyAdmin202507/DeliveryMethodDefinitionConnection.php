...
use Fo3nix\ShopifyGraphQL\ShopifyAdmin202507\DeliveryMethodDefinitionEdge;
use Fo3nix\ShopifyGraphQL\ShopifyAdmin202507\DeliveryMethodDefinition;
    ...
    public function getPageInfo()
    {
        ...
        public static function fromArray(array $data): self
        {
            ...
            if (isset($data['edges']) && $data['edges'] !== null) {
                $instance->edges = array_map(function($item) { return DeliveryMethodDefinitionEdge::fromArray($item); }, $data['edges']);
            }
            if (isset($data['nodes']) && $data['nodes'] !== null) {
                $instance->nodes = array_map(function($item) { return DeliveryMethodDefinition::fromArray($item); }, $data['nodes']);
            }
