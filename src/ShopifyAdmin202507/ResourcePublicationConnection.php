...
use Fo3nix\ShopifyGraphQL\ShopifyAdmin202507\ResourcePublicationEdge;
use Fo3nix\ShopifyGraphQL\ShopifyAdmin202507\ResourcePublication;
use Fo3nix\ShopifyGraphQL\ShopifyAdmin202507\PageInfo;

class ResourcePublicationConnection
{
    protected $edges;
    protected $nodes;
    protected $pageInfo;
    ...
    public function getPageInfo()
    {
        ...
        public static function fromArray(array $data): self
        {
            ...
            if (isset($data['edges']) && $data['edges'] !== null) {
                $instance->edges = array_map(function($item) { return ResourcePublicationEdge::fromArray($item); }, $data['edges']);
            }
            if (isset($data['nodes']) && $data['nodes'] !== null) {
                $instance->nodes = array_map(function($item) { return ResourcePublication::fromArray($item); }, $data['nodes']);
            }
