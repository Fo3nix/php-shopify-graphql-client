...
use Fo3nix\ShopifyGraphQL\ShopifyAdmin202507\AppCreditEdge;
use Fo3nix\ShopifyGraphQL\ShopifyAdmin202507\AppCredit;
use Fo3nix\ShopifyGraphQL\ShopifyAdmin202507\PageInfo;

class AppCreditConnection
{
    protected $edges;
    protected $nodes;
    protected $pageInfo;
    ...
    public function getPageInfo()
    {
        ...
        public static function fromArray(array $data): self
        {
            ...
            if (isset($data['edges']) && $data['edges'] !== null) {
                $instance->edges = array_map(function($item) { return AppCreditEdge::fromArray($item); }, $data['edges']);
            }
            if (isset($data['nodes']) && $data['nodes'] !== null) {
                $instance->nodes = array_map(function($item) { return AppCredit::fromArray($item); }, $data['nodes']);
            }
