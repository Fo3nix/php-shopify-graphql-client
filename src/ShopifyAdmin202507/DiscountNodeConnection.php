...
use Fo3nix\ShopifyGraphQL\ShopifyAdmin202507\DiscountNodeEdge;
    ...
    public function getPageInfo()
    {
        ...
        public static function fromArray(array $data): self
        {
            ...
            if (isset($data['edges']) && $data['edges'] !== null) {
                $instance->edges = array_map(function($item) { return DiscountNodeEdge::fromArray($item); }, $data['edges']);
            }
            if (isset($data['nodes']) && $data['nodes'] !== null) {
                $instance->nodes = array_map(function($item) { return DiscountNode::fromArray($item); }, $data['nodes']);
            }
