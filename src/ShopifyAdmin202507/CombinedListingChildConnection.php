...
use Fo3nix\ShopifyGraphQL\ShopifyAdmin202507\CombinedListingChildEdge;
use Fo3nix\ShopifyGraphQL\ShopifyAdmin202507\CombinedListingChild;
use Fo3nix\ShopifyGraphQL\ShopifyAdmin202507\PageInfo;

class CombinedListingChildConnection
{
    protected $edges;
    protected $nodes;
    protected $pageInfo;
    ...
    public function getPageInfo()
    {
        ...
        public static function fromArray(array $data): self
        {
            ...
            if (isset($data['edges']) && $data['edges'] !== null) {
                $instance->edges = array_map(function($item) { return CombinedListingChildEdge::fromArray($item); }, $data['edges']);
            }
            if (isset($data['nodes']) && $data['nodes'] !== null) {
                $instance->nodes = array_map(function($item) { return CombinedListingChild::fromArray($item); }, $data['nodes']);
            }
