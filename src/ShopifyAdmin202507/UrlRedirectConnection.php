...
use Fo3nix\ShopifyGraphQL\ShopifyAdmin202507\UrlRedirectEdge;
use Fo3nix\ShopifyGraphQL\ShopifyAdmin202507\UrlRedirect;
use Fo3nix\ShopifyGraphQL\ShopifyAdmin202507\PageInfo;

class UrlRedirectConnection
{
    protected $edges;
    protected $nodes;
    protected $pageInfo;
    ...
    public function getPageInfo()
    {
        ...
        public static function fromArray(array $data): self
        {
            ...
            if (isset($data['edges']) && $data['edges'] !== null) {
                $instance->edges = array_map(function($item) { return UrlRedirectEdge::fromArray($item); }, $data['edges']);
            }
            if (isset($data['nodes']) && $data['nodes'] !== null) {
                $instance->nodes = array_map(function($item) { return UrlRedirect::fromArray($item); }, $data['nodes']);
            }
