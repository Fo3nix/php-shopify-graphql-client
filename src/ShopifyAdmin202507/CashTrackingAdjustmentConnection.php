...
use Fo3nix\ShopifyGraphQL\ShopifyAdmin202507\CashTrackingAdjustmentEdge;
use Fo3nix\ShopifyGraphQL\ShopifyAdmin202507\CashTrackingAdjustment;
use Fo3nix\ShopifyGraphQL\ShopifyAdmin202507\PageInfo;

class CashTrackingAdjustmentConnection
{
    protected $edges;
    protected $nodes;
    protected $pageInfo;
    ...
    public function getPageInfo()
    {
        ...
        public static function fromArray(array $data): self
        {
            ...
            if (isset($data['edges']) && $data['edges'] !== null) {
                $instance->edges = array_map(function($item) { return CashTrackingAdjustmentEdge::fromArray($item); }, $data['edges']);
            }
            if (isset($data['nodes']) && $data['nodes'] !== null) {
                $instance->nodes = array_map(function($item) { return CashTrackingAdjustment::fromArray($item); }, $data['nodes']);
            }
