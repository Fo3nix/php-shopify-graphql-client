...
class DiscountCodeFreeShippingQueryObject extends QueryObject
{
    ...
    public function selectCodes(DiscountCodeFreeShippingCodesArgumentsObject $argsObject = null)
    {
    ...
    public function selectCodesCount(DiscountCodeFreeShippingCodesCountArgumentsObject $argsObject = null)
    {
    ...
    public function selectCombinesWith(DiscountCodeFreeShippingCombinesWithArgumentsObject $argsObject = null)
    {
     ...
     */
    public function selectCustomerSelection(DiscountCodeFreeShippingCustomerSelectionArgumentsObject $argsObject = null)
    {
    ...
    public function selectDestinationSelection(DiscountCodeFreeShippingDestinationSelectionArgumentsObject $argsObject = null)
    {
    ...
    public function selectMaximumShippingPrice(DiscountCodeFreeShippingMaximumShippingPriceArgumentsObject $argsObject = null)
    {
    ...
    public function selectMinimumRequirement(DiscountCodeFreeShippingMinimumRequirementArgumentsObject $argsObject = null)
    {
    ...
    public function selectShareableUrls(DiscountCodeFreeShippingShareableUrlsArgumentsObject $argsObject = null)
    {
    ...
    public function selectTotalSales(DiscountCodeFreeShippingTotalSalesArgumentsObject $argsObject = null)
    {
