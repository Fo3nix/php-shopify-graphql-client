...
use Fo3nix\ShopifyGraphQL\ShopifyAdmin202507\SegmentFilterEdge;
use Fo3nix\ShopifyGraphQL\ShopifyAdmin202507\PageInfo;

class SegmentFilterConnection
{
    protected $edges;
    protected $nodes;
    protected $pageInfo;
    ...
    public function getPageInfo()
    {
        ...
        public static function fromArray(array $data): self
        {
            ...
            if (isset($data['edges']) && $data['edges'] !== null) {
                $instance->edges = array_map(function($item) { return SegmentFilterEdge::fromArray($item); }, $data['edges']);
            }
