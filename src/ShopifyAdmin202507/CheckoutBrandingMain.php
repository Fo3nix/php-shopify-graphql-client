...
use Fo3nix\ShopifyGraphQL\ShopifyAdmin202507\CheckoutBrandingMainSection;

class CheckoutBrandingMain
{
    ...
    public function getSection()
    {
        ...
        public static function fromArray(array $data): self
        {
            ...
            if (isset($data['section']) && $data['section'] !== null) {
                $instance->section = CheckoutBrandingMainSection::fromArray($data['section']);
            }
            return $instance;
        }
