...
use Fo3nix\ShopifyGraphQL\ShopifyAdmin202507\PaymentCustomizationEdge;
use Fo3nix\ShopifyGraphQL\ShopifyAdmin202507\PaymentCustomization;
use Fo3nix\ShopifyGraphQL\ShopifyAdmin202507\PageInfo;

class PaymentCustomizationConnection
{
    protected $edges;
    protected $nodes;
    protected $pageInfo;
    ...
    public function getPageInfo()
    {
        ...
        public static function fromArray(array $data): self
        {
            ...
            if (isset($data['edges']) && $data['edges'] !== null) {
                $instance->edges = array_map(function($item) { return PaymentCustomizationEdge::fromArray($item); }, $data['edges']);
            }
            if (isset($data['nodes']) && $data['nodes'] !== null) {
                $instance->nodes = array_map(function($item) { return PaymentCustomization::fromArray($item); }, $data['nodes']);
            }
