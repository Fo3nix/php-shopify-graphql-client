...
use Fo3nix\ShopifyGraphQL\ShopifyAdmin202507\MarketRegionEdge;
use Fo3nix\ShopifyGraphQL\ShopifyAdmin202507\PageInfo;

class MarketRegionConnection
{
    protected $edges;
    protected $nodes;
    protected $pageInfo;
    ...
    public function getPageInfo()
    {
        ...
        public static function fromArray(array $data): self
        {
            ...
            if (isset($data['edges']) && $data['edges'] !== null) {
                $instance->edges = array_map(function($item) { return MarketRegionEdge::fromArray($item); }, $data['edges']);
            }
