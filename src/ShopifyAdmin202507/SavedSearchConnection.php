...
use Fo3nix\ShopifyGraphQL\ShopifyAdmin202507\SavedSearchEdge;
use Fo3nix\ShopifyGraphQL\ShopifyAdmin202507\SavedSearch;
use Fo3nix\ShopifyGraphQL\ShopifyAdmin202507\PageInfo;

class SavedSearchConnection
{
    protected $edges;
    protected $nodes;
    protected $pageInfo;
    ...
    public function getPageInfo()
    {
        ...
        public static function fromArray(array $data): self
        {
            ...
            if (isset($data['edges']) && $data['edges'] !== null) {
                $instance->edges = array_map(function($item) { return SavedSearchEdge::fromArray($item); }, $data['edges']);
            }
            if (isset($data['nodes']) && $data['nodes'] !== null) {
                $instance->nodes = array_map(function($item) { return SavedSearch::fromArray($item); }, $data['nodes']);
            }
