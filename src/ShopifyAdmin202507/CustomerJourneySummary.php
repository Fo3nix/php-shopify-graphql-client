...
use Fo3nix\ShopifyGraphQL\ShopifyAdmin202507\CustomerMomentConnection;
    ...
    public function getReady()
    {
        ...
        public static function fromArray(array $data): self
        {
            ...
            if (isset($data['moments']) && $data['moments'] !== null) {
                $instance->moments = CustomerMomentConnection::fromArray($data['moments']);
            }
            if (isset($data['momentsCount']) && $data['momentsCount'] !== null) {
                $instance->momentsCount = Count::fromArray($data['momentsCount']);
            }
