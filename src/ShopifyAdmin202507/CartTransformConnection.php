...
use Fo3nix\ShopifyGraphQL\ShopifyAdmin202507\CartTransformEdge;
use Fo3nix\ShopifyGraphQL\ShopifyAdmin202507\CartTransform;
use Fo3nix\ShopifyGraphQL\ShopifyAdmin202507\PageInfo;

class CartTransformConnection
{
    protected $edges;
    protected $nodes;
    protected $pageInfo;
    ...
    public function getPageInfo()
    {
        ...
        public static function fromArray(array $data): self
        {
            ...
            if (isset($data['edges']) && $data['edges'] !== null) {
                $instance->edges = array_map(function($item) { return CartTransformEdge::fromArray($item); }, $data['edges']);
            }
            if (isset($data['nodes']) && $data['nodes'] !== null) {
                $instance->nodes = array_map(function($item) { return CartTransform::fromArray($item); }, $data['nodes']);
            }
