...
use Fo3nix\ShopifyGraphQL\ShopifyAdmin202507\PageEdge;
use Fo3nix\ShopifyGraphQL\ShopifyAdmin202507\Page;
    ...
    public function getPageInfo()
    {
        ...
        public static function fromArray(array $data): self
        {
            ...
            if (isset($data['edges']) && $data['edges'] !== null) {
                $instance->edges = array_map(function($item) { return PageEdge::fromArray($item); }, $data['edges']);
            }
            if (isset($data['nodes']) && $data['nodes'] !== null) {
                $instance->nodes = array_map(function($item) { return Page::fromArray($item); }, $data['nodes']);
            }
