...
use Fo3nix\ShopifyGraphQL\ShopifyAdmin202507\TranslatableResourceEdge;
use Fo3nix\ShopifyGraphQL\ShopifyAdmin202507\TranslatableResource;
use Fo3nix\ShopifyGraphQL\ShopifyAdmin202507\PageInfo;

class TranslatableResourceConnection
{
    protected $edges;
    protected $nodes;
    protected $pageInfo;
    ...
    public function getPageInfo()
    {
        ...
        public static function fromArray(array $data): self
        {
            ...
            if (isset($data['edges']) && $data['edges'] !== null) {
                $instance->edges = array_map(function($item) { return TranslatableResourceEdge::fromArray($item); }, $data['edges']);
            }
            if (isset($data['nodes']) && $data['nodes'] !== null) {
                $instance->nodes = array_map(function($item) { return TranslatableResource::fromArray($item); }, $data['nodes']);
            }
