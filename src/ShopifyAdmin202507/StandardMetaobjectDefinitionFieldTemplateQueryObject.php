...
class StandardMetaobjectDefinitionFieldTemplateQueryObject extends QueryObject
{
    ...
    public function selectType(StandardMetaobjectDefinitionFieldTemplateTypeArgumentsObject $argsObject = null)
    {
    ...
    public function selectValidations(StandardMetaobjectDefinitionFieldTemplateValidationsArgumentsObject $argsObject = null)
    {
