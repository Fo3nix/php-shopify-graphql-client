...
use Fo3nix\ShopifyGraphQL\ShopifyAdmin202507\DiscountApplicationEdge;
    ...
    public function getPageInfo()
    {
        ...
        public static function fromArray(array $data): self
        {
            ...
            if (isset($data['edges']) && $data['edges'] !== null) {
                $instance->edges = array_map(function($item) { return DiscountApplicationEdge::fromArray($item); }, $data['edges']);
            }
